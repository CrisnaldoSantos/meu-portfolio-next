...
import { Hero as HeroType } from "../../services/types";

interface HeroProps {
  heroData?: HeroType | null;
}

const Hero = ({ heroData: initialHeroData }: HeroProps) => {
  const [typingText, setTypingText] = useState("");

  // Use dados iniciais do servidor ou valores padrão
    ...
    <section id="hero" className="min-h-screen flex flex-col justify-center">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl">
          ...
          >
            {heroData?.buttonLabel || "Veja meus projetos!"}
          </button>
        </div>
      </div>
    </section>
